...
fn main() {
    ...
    // A.23.4 - variabel struct tanpa predefined value
    let car_three: Car;
    car_three = Car {
    ...
    // A.23.4 - variabel struct dengan nilai dari struct lain
    let car_four: Car;
    car_four = Car {
    ...
    // A.23.6 - debugging dengan #[derive(Debug)]
